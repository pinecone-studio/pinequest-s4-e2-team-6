import { images, planStops } from "../data/content";
      ...
      <section className="grid gap-6 py-6 md:grid-cols-[0.85fr_1.35fr]">
        <div className="space-y-5">
          <div className="glass-panel rounded-[28px] p-6">
            <p className="text-xs font-black uppercase tracking-[0] text-black/50 dark:text-white/50">Та</p>
            <p className="mt-3 text-xl font-semibold">“Өнөөдөр 50,000₮ төсөвтэй, 6 цагийн завтай.”</p>
          </div>
          <div className="glass-panel rounded-[28px] p-6">
            <div className="mb-5 flex items-center gap-3">
              ...
              <span className="text-xs font-black uppercase tracking-[0] text-[#00658b] dark:text-[#7dd0ff]">AI Nomad төлөвлөгөө</span>
            </div>
            <h2 className="text-3xl font-black tracking-[0]">Улаанбаатар экспресс: соёл ба хоол</h2>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <StatCard icon="schedule" value="5.5 цаг" label="тооцоолсон хугацаа" />
              <StatCard icon="payments" value="42k ₮" label="тооцоолсон зардал" />
            </div>
          </div>
        </div>
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            {planStops.map(([time, title, description, duration, price]) => (
